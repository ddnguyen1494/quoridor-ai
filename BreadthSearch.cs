...
namespace BreadthSearch
{
    ...
    class Graph<T>
    {
        ...
        public Node<T>[] BFS(T goal, bool print)
        {
            ...
            if (print)
            {
                Console.WriteLine("Open: " + arrayToString(open, openTop, openEnd - 1));
                Console.WriteLine("Closed: " + arrayToString(closed, 0, closedTop));
            }
            while (openTop < allNodes.Count)
            {
                ...
                {
                    var output = getPath(open[openTop], closed);
                    if (print)
                    {
                ...
                if (print)
                {
                    Console.WriteLine(x.contents);
                    Console.WriteLine("Open: " + arrayToString(open, openTop, openEnd - 1));
                    Console.WriteLine("Closed: " + arrayToString(closed, 0, closedTop - 1));
                }
            }
            openTop++;
            if (print)
            {
                Console.WriteLine("Open: " + arrayToString(open, openTop, openEnd));
                Console.WriteLine("Closed: " + arrayToString(closed, 0, closedTop - 1));
